...
function current(l,s,p){
 if(l===1){return graph(v=>v/2,{xmax:4,ymax:2,xlabel:'電圧 V [V]',ylabel:'電流 I [A]',p:1})+circle(100+720*p,295-210*p,9,C.gold)+text('抵抗 2 Ω の例：I = V/2',260,45,28)+text('オームの法則を使う間は、抵抗 R を一定とする',140,370,24);}
