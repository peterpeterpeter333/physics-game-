...
import {applyBohrEnergy} from '../docs/video-revision-20260924/bohr-energy.mjs';
import {applyBohrRadius} from '../docs/video-revision-20260924/bohr-radius.mjs';
import {applyMatterWaves} from '../docs/video-revision-20260924/matter-waves.mjs';
import {applyAtomicSpectra} from '../docs/video-revision-20260924/atomic-spectra.mjs';
import {applyPhotoelectricEnergy} from '../docs/video-revision-20260924/photoelectric-energy.mjs';
import {applyPhotonFoundations} from '../docs/video-revision-20260924/photon-foundations.mjs';
import {applyCapacitorEnergy} from '../docs/video-revision-20260924/capacitor-energy.mjs';
import {applyCapacitorGeometry} from '../docs/video-revision-20260924/capacitor-geometry.mjs';
import {applyCapacitorIntro} from '../docs/video-revision-20260924/capacitor-intro.mjs';
import {applyElectricPotential} from '../docs/video-revision-20260924/electric-potential.mjs';
...
import {applyJouleHeating} from '../docs/video-revision-20260924/joule-heating.mjs';
...
applyElectricPotential(plan);
applyCapacitorIntro(plan);
applyCapacitorGeometry(plan);
applyCapacitorEnergy(plan);
applyPhotonFoundations(plan);
applyPhotoelectricEnergy(plan);
applyAtomicSpectra(plan);
applyMatterWaves(plan);
applyBohrRadius(plan);
applyBohrEnergy(plan);
