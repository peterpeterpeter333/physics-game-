...
assert.ok(process.argv.slice(2).length<=1&&process.argv.slice(2).every(a=>['--uniform','--freefall','--projectile-foundations','--force','--work-foundations','--work-components','--potential-energy','--spring-energy','--momentum-foundations','--momentum-advanced','--shm-middle','--sine-motion','--shm-advanced','--foundation-appendices','--heat-melting','--gas-foundations','--gas-temperature','--gas-states','--ideal-gas-foundations','--mole-foundations','--ideal-gas-advanced','--gas-work','--firstlaw-foundations','--heat-cycle','--wave-foundations','--wave-speed','--traveling-wave','--sound-boundaries','--sound-beats','--doppler-source','--doppler-observer','--light-refraction','--total-reflection','--light-interference','--double-slit','--single-slit'].includes(a)),'Unknown publication scope');
