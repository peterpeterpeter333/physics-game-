...
assert.ok(ids.every(id=>[...momentumMiddleIds,...motionFoundationIds,...uniformAccelerationIds,...projectileMiddleIds,...[...uniformContinuationIds,...freefallIds,...projectileFoundationIds,...forceIds,...workFoundationIds,...workComponentIds,...potentialEnergyIds,...springEnergyIds,...momentumFoundationIds].filter(id=>!/^h[mp]-why-/.test(id))].includes(id)),'Only authored films can be registered');
for(const id of ids){
