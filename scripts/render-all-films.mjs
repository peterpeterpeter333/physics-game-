...
import {bohrEnergyFrame} from './bohr-energy-visuals.mjs';
import {bohrRadiusFrame} from './bohr-radius-visuals.mjs';
import {matterWaveFrame} from './matter-wave-visuals.mjs';
import {atomicSpectraFrame} from './atomic-spectra-visuals.mjs';
import {photoelectricEnergyFrame} from './photoelectric-energy-visuals.mjs';
import {photonFoundationFrame} from './photon-foundation-visuals.mjs';
import {capacitorEnergyFrame} from './capacitor-energy-visuals.mjs';
import {capacitorGeometryFrame} from './capacitor-geometry-visuals.mjs';
import {capacitorIntroFrame} from './capacitor-intro-visuals.mjs';
import {electricPotentialFrame} from './electric-potential-visuals.mjs';
import {coulombFieldFrame} from './coulomb-field-visuals.mjs';
import {electricFieldIntroFrame} from './electric-field-intro-visuals.mjs';
import {faradayLenzFrame} from './faraday-lenz-visuals.mjs';
import {magneticFluxFrame} from './magnetic-flux-visuals.mjs';
import {magneticFoundationFrame} from './magnetic-foundation-visuals.mjs';
import {powerTransmissionFrame} from './power-transmission-visuals.mjs';
import {jouleHeatingFrame} from './joule-heating-visuals.mjs';
import {powerFoundationFrame} from './power-foundation-visuals.mjs';
import {resistorCircuitFrame} from './resistor-circuit-visuals.mjs';
import {currentFoundationFrame} from './current-foundation-visuals.mjs';
import {singleSlitFrame} from './single-slit-visuals.mjs';
import {doubleSlitFrame} from './double-slit-visuals.mjs';
import {lightInterferenceFrame} from './light-interference-visuals.mjs';
import {totalReflectionFrame} from './total-reflection-visuals.mjs';
import {lightRefractionFrame} from './light-refraction-visuals.mjs';
import {lightFoundationFrame} from './light-foundation-visuals.mjs';
import {dopplerObserverFrame} from './doppler-observer-visuals.mjs';
import {dopplerSourceFrame} from './doppler-source-visuals.mjs';
import {soundBeatFrame} from './sound-beat-visuals.mjs';
import {soundBoundaryFrame} from './sound-boundary-visuals.mjs';
import {soundFoundationFrame} from './sound-foundation-visuals.mjs';
import {waveSuperpositionFrame} from './wave-superposition-visuals.mjs';
import {travelingWaveFrame} from './traveling-wave-visuals.mjs';
import {waveSpeedFrame} from './wave-speed-visuals.mjs';
import {waveFoundationFrame} from './wave-foundation-visuals.mjs';
import {heatCycleFrame} from './heat-cycle-visuals.mjs';
...
for(const [i,entry] of plan.entries()){
 ...
 if(clip.visualPilot==='coulomb-prerequisite-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./coulomb-prerequisite-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='capacitor-geometry-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./capacitor-geometry-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='capacitor-energy-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./capacitor-energy-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='photon-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./photon-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='photoelectric-energy-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./photoelectric-energy-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='atomic-spectra-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./atomic-spectra-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='matter-waves-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./matter-wave-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='bohr-radius-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./bohr-radius-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='bohr-energy-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./bohr-energy-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='capacitor-intro-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./capacitor-intro-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='electric-potential-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./electric-potential-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='coulomb-field-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./coulomb-field-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='electric-field-intro-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./electric-field-intro-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='faraday-lenz-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./faraday-lenz-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='magnetic-flux-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./magnetic-flux-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='magnetic-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./magnetic-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='power-transmission-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./power-transmission-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='joule-heating-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./joule-heating-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='power-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./power-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='resistor-circuits-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./resistor-circuit-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='current-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./current-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='single-slit-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./single-slit-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='double-slit-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./double-slit-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='light-interference-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./light-interference-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='total-reflection-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./total-reflection-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='light-refraction-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./light-refraction-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='light-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./light-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='doppler-observer-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./doppler-observer-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='doppler-source-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./doppler-source-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='sound-beats-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./sound-beat-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='sound-boundaries-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./sound-boundary-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='sound-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./sound-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='wave-superposition-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./wave-superposition-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='traveling-wave-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./traveling-wave-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='wave-speed-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./wave-speed-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='wave-foundations-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./wave-foundation-visuals.mjs',import.meta.url)));}
 if(clip.visualPilot==='heat-cycle-v1'){hash.update(readFileSync(new URL('./motion-foundation-visuals.mjs',import.meta.url)));hash.update(readFileSync(new URL('./heat-cycle-visuals.mjs',import.meta.url)));}
 ...
 const preserveAudio=process.env.FILM_COPY_AUDIO==='1';
 const audioFile=`${cache}/${clip.id}.${preserveAudio?'m4a':'wav'}`;
 if(preserveAudio){
  const provenance=JSON.parse(readFileSync(`${cache}/${clip.id}.audio-source.json`));
  if(provenance.audioSha256!==createHash('sha256').update(readFileSync(audioFile)).digest('hex'))throw Error(`Recovered audio changed: ${clip.id}`);
 }
 const child=spawn(process.env.FFMPEG,['-y','-v','error','-f','rawvideo','-pixel_format','rgb24','-video_size','1280x760','-framerate',String(fps),'-i','pipe:0','-i',audioFile,'-c:v','libx264','-preset','veryfast','-crf','24','-pix_fmt','yuv420p','-r',String(clip.visualPilot?fps:24),...(preserveAudio?['-c:a','copy']:['-c:a','aac','-b:a','96k']),'-t',String(clip.duration),'-movflags','+faststart',partial],{stdio:['pipe','inherit','inherit']});
