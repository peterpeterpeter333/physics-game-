...
function frame(c,s,t){
 const work=gasTemperatureFrame(c,s,t)??gasFoundationFrame(c,s,t)??heatMeltingFrame(c,s,t)??foundationAppendixFrame(c,s,t)??heatFoundationFrame(c,s,t)??shmAdvancedFrame(c,s,t)??sineMotionFrame(c,s,t)??sineDerivativeFrame(c,s,t)??shmMiddleFrame(c,s,t)??shmFoundationFrame(c,s,t)??circularFoundationFrame(c,s,t)??radianFoundationFrame(c,s,t)??momentumAdvancedFrame(c,s,t)??momentumMiddleFrame(c,s,t)??momentumFoundationFrame(c,s,t)??springEnergyFrame(c,s,t)??potentialEnergyFrame(c,s,t)??workComponentFrame(c,s,t)??workFoundationFrame(c,s,t);if(work)return work;
