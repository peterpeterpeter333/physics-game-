...
import {applyDopplerSource,dopplerSourceIds} from '../docs/video-revision-20260924/doppler-source.mjs';
import {dopplerSourceFrame,dopplerSourceKinds,dopplerSourceDiagram} from './doppler-source-visuals.mjs';
const plan=JSON.parse(readFileSync('docs/video-revision-20260924/full-plan.generated.json'));applyDopplerSource(plan);
let count=0;const seen=new Set();
for(const id of dopplerSourceIds){const c=plan.find(c=>c.id===id);assert.ok(c.manuscriptScenes);let t=0;
