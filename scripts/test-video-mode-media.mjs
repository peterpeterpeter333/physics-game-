...
for(const clip of [...main,...inserts]){
 ...
 for(let i=0;i<clip.scenes.length;i++){
  ...
  for(const [j,p]of (s.utterances??[]).entries()){
   ...
   if(['motion-foundations-v1','motion-inserts-v1','uniform-acceleration-v1','uniform-continuation-v1','freefall-v1','projectile-foundations-v1','projectile-middle-v1','addition-theorem-v1','projectile-advanced-v1','force-storyboards-v1'].includes(clip.visualPilot)){
