...
// University-mechanics films rewritten from docs/video-revision-20260924/umech/*.mjs.
const umech=await (await import('./umech/build-plan.mjs')).buildPlan();
for(const clip of [...main,...inserts]){
 const expected=clip.revision==='20260924-pilot'?pilot:clip.revision==='20260926-umech'?umech:full;
 ...
 for(let i=0;i<clip.scenes.length;i++){
  ...
  for(const [j,p]of (s.utterances??[]).entries()){
   ...
   if(['umech-v1','motion-foundations-v1','motion-inserts-v1','uniform-acceleration-v1','uniform-continuation-v1','freefall-v1','projectile-foundations-v1','projectile-middle-v1','addition-theorem-v1','projectile-advanced-v1','force-storyboards-v1','work-foundations-v1','work-components-v1','potential-energy-v1','spring-energy-v1','momentum-foundations-v1','momentum-middle-v1','momentum-advanced-v1','radian-foundations-v1','circular-foundations-v1','shm-foundations-v1','shm-middle-v1','sine-derivative-v1','sine-motion-v1','shm-advanced-v1','heat-foundations-v1','foundation-appendices-v1','heat-melting-v1','gas-foundations-v1','gas-temperature-v1','gas-states-v1','ideal-gas-foundations-v1','mole-foundations-v1','gas-particles-v1','ideal-gas-advanced-v1','gas-work-v1','firstlaw-foundations-v1','heat-cycle-v1','wave-foundations-v1','wave-speed-v1','traveling-wave-v1','wave-superposition-v1','sound-foundations-v1','sound-boundaries-v1','sound-beats-v1','doppler-source-v1','doppler-observer-v1','light-foundations-v1','light-refraction-v1','total-reflection-v1','light-interference-v1','double-slit-v1','single-slit-v1','current-foundations-v1','resistor-circuits-v1','power-foundations-v1','joule-heating-v1','power-transmission-v1','magnetic-foundations-v1','magnetic-flux-v1','faraday-lenz-v1','electric-field-intro-v1','coulomb-field-v1','coulomb-prerequisite-v1','electric-potential-v1','capacitor-intro-v1','capacitor-geometry-v1','capacitor-energy-v1','photon-foundations-v1','photoelectric-energy-v1','atomic-spectra-v1','matter-waves-v1','bohr-radius-v1','bohr-energy-v1'].includes(clip.visualPilot)){
    ...
    // These two reviewed cues add a missing definition / upward-motion caveat.
    // They remain one visual focus, fit the renderer's three caption lines,
    // and are synthesized as a single utterance. Do not relax other cues.
    const reviewedThree=clip.id==='m-projectile-middle'&&j===1&&(i===0||i===1);
    assert.ok(sentences>=1&&sentences<=(reviewedThree?3:2),`${clip.id}/${i}/${j}: sentence count ${sentences}`);
