...
const beats={
 ...
 'ue-integrals:10': [r`(x_B^2+y_B^2)-(x_A^2+y_A^2)`,r`W_{A\to B}=\frac{q\alpha}{2}[(x_B^2+y_B^2)-(x_A^2+y_A^2)]`,r`W_{A\to B}=\frac{q\alpha}{2}[(x_B^2+y_B^2)-(x_A^2+y_A^2)]`,r`U_B-U_A=-W_{A\to B}`],
 'ue-integrals:11':[r`V=U/q`,r`V_B-V_A=(U_B-U_A)/q=-W_{A\to B}/q`],
 'ue-integrals:12':[r`\text{動かない電荷がつくる静電場}`,r`V_B-V_A=-\int_A^B\vec E\cdot d\vec r`,r`\oint_C\vec E\cdot d\vec r=0\quad\text{（静電場）}`],
 ...
 'ue-integrals:20':[r`A=R^2\int_0^{2\pi}\int_0^\pi\sin\theta\,d\theta\,d\varphi`,r`\int_0^\pi\sin\theta\,d\theta=[-\cos\theta]_0^\pi=2`,r`\int_0^{2\pi}1\,d\varphi=2\pi`,r`A=R^2\times2\times2\pi=4\pi R^2`],
 ...
 'ue-gauss:21':[r`\vec E=E\vec n\quad\text{（電荷を中心とする球面）}`,r`E=\text{球面上で一定}`,r`E(4\pi r^2)=Q/\varepsilon_0\quad\Rightarrow\quad E=\frac{Q}{4\pi\varepsilon_0r^2}\ (Q>0)`],
 ...
 'ue-maxwell:7':[r`E_y=f(x-ct)`,r`x-ct=\text{一定}\quad\Rightarrow\quad x=ct+\text{一定}`,r`f''=\mu_0\varepsilon_0c^2f''`,r`c=\frac1{\sqrt{\mu_0\varepsilon_0}}`],
 'um-current-field:4':[r`\oint\vec B\cdot d\vec l=\mu_0 I`,r`\oint\vec B\cdot d\vec l=B(2\pi r)`,r`B=\frac{\mu_0 I}{2\pi r}`],
