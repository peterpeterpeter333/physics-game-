...
export function applyMotionInserts(plan){
 for(const id of motionInsertIds){
  ...
  if(id==='hm-why-03')cues=[
   ...
   cue(1,D('one-second-secants-1'),'時間の幅が一秒なら、平均速度は毎秒三メートルです。','じかんのはばがいちびょうなら、へいきんそくどはまいびょうさんメートルです。'),
   cue(1,D('one-second-secants-01'),'時間の幅が〇・一秒なら、平均速度は毎秒二・一メートルです。','じかんのはばがれいてんいちびょうなら、へいきんそくどはまいびょうにてんいちメートルです。'),
   cue(1,D('one-second-secants-001'),'時間の幅が〇・〇一秒なら、平均速度は毎秒二・〇一メートルです。','じかんのはばがれいてんれいいちびょうなら、へいきんそくどはまいびょうにてんれいいちメートルです。'),
   ...
   cue(4,F(['\\bar v','=','\\frac{h(2+h)}{h}'],'分子の二つの項に共通する h を取り出す',['\\bar v','=','\\frac{2h+h^2}{h}']),'二つの項には、どちらもエイチが掛かっています。分子は、二足すエイチの全体に、エイチを掛けた形にできます。','ふたつのこうには、どちらもエイチがかかっています。ぶんしは、にたすエイチのぜんたいに、エイチをかけたかたちにできます。'),
  ...
  if(id==='hm-why-04')cues=[
   cue(0,D('equal-speed-vectors')),cue(1,D('velocity-triangle'),'二本の速度の矢印の根元をそろえると、その二本と速度の変化で、二等辺三角形ができます。','にほんのそくどのやじるしのねもとをそろえると、そのにほんとそくどのへんかで、にとうへんさんかくけいができます。'),
   cue(2,D('triangle-angle-labels'),'二本の速度が根元で作る角を、頂角と呼びます。赤い辺と青い辺の間の角は、底角の一つです。','にほんのそくどがねもとでつくるかくを、ちょうかくとよびます。あかいへんとあおいへんのあいだのかくは、ていかくのひとつです。'),
   cue(2,F(['\\text{底角}','=','\\frac{180^\\circ-\\text{頂角}}{2}'],'三角形の内角の和は180°／二等辺三角形の底角は等しい'),'三角形の内角の合計は百八十度で、二つの底角は等しいです。一つの底角は、百八十度から頂角を引いて、二で割った値になります。','さんかくけいのないかくのごうけいはひゃくはちじゅうどで、ふたつのていかくはひとしいです。ひとつのていかくは、ひゃくはちじゅうどからちょうかくをひいて、にでわったあたいになります。'),
   cue(2,D('triangle-limit')),
  ...
  const groups=id==='hm-why-03'?[cues.slice(0,5),cues.slice(5,12),cues.slice(12)]:[cues];
