...
触覚フィードバック、ネイティブのスプラッシュ/ステータスバー、258問の独自コンテンツ。
...
## 収録コンテンツ(高校5分野+大学3分野・55ステージ・258問・公式87本)
...
| 📐 数学の武器庫【大学編】 (8) | 微分 / 積分 / 微分の道具箱 / 近似 / ベクトルと内積 / 外積 / 微分方程式 / 単振動の方程式 |
...
レッスンには**40種のアニメーションSVG図解**が組み込まれている(v-tグラフの面積、気体分子の運動、
