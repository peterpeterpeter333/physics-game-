...
export const universityCurriculum:UniversityTopic[]=[
 ...
 {id:'ue-capacitor',family:'uem',intro:p('ui-capacitance',[0,1,6],'二枚の板に正負の電荷を分けて蓄え、容量と充電中の電圧を読む。'),middle:p('um-capacitance',[2,3,4,5,7],'面電荷密度から、平行板コンデンサの電場・電圧・容量を求める。'),advanced:'充電仕事を積分してエネルギー密度を導き、誘電体と固定条件の違いを調べる。'},
